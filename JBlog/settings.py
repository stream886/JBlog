...
SECRET_KEY = 'rqx^jzj8ecv26+$x3n0tfwe2uyg6e-06i=z+^=#v6!ik7ijr(x'
...
# STATIC_URL 是在Django具体APP下建立的static目录，用来存放静态资源
STATIC_URL = '/static/'

# STATICFILES_DIRS设置通用的静态资源，对应的目录不放在APP下，而是放在Project下
